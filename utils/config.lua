...
Config.DefaultConfig = {
    ...
    ['DoRez']                = {
        ...
        Category = "Heal/Rez",
        Index = 12,
        Tooltip = "Whether the character will attempt to rez (if able) in any situation.",
        Default = false,
        ConfigType = "Advanced",
        FAQ = "Why am I not rezzing?",
        Answer = "[DoRez] must be true to enable rezzing ooc. [DoRez] AND [DoBattleRez] must be true to enable rezzing in combat.",        
    },
    ['RetryRezDelay']        = {
    ...
    ['DoBattleRez']          = {
        ...
        Category = "Heal/Rez",
        Index = 14,
        Tooltip = "Allow attmpts to rez while in combat.",
        Default = mq.TLO.Me.Class.ShortName():lower() == "clr",
        ConfigType = "Advanced",
        FAQ = "Why am I not rezzing in combat?",
        Answer = "You can set the [DoBattleRez] option to true to use Rez while in combat. Note [DoRez] also must be true as a baseline.",
    },
    ['InstantRelease']       = {
